...
class PublishEbayListingEndpointTests(unittest.TestCase):
    ...
    def test_sends_both_front_and_back_image_urls(self):
        ...
        # Cache-Buster-Query-Parameter (siehe _publish_listing()) haengt an
        # jeder URL, daher startswith() statt exaktem Vergleich.
        self.assertEqual(len(image_urls), 2)
        self.assertTrue(image_urls[0].startswith("https://img/b1/1_front.jpg?v="))
        self.assertTrue(image_urls[1].startswith("https://img/b1/1_back.jpg?v="))
    ...
    def test_includes_extra_photos_after_front_and_back_capped_at_twelve(self):
        ...
        self.assertTrue(image_urls[0].startswith("https://img/b1/1_front.jpg?v="))
        self.assertTrue(image_urls[1].startswith("https://img/b1/1_back.jpg?v="))
        self.assertTrue(image_urls[2].startswith("https://img/b1/1_extra_0.jpg?v="))
